 ...
 */
var scratchWorld2 = new THREE.Vector3();
THREEx.ObjCoord.worldPosition	= function(object3d){
	object3d.updateMatrixWorld();
	var worldMatrix	= object3d.matrixWorld;
	scratchWorld2.setFromMatrixPosition(worldMatrix);
	return scratchWorld2;
}
...
var scratchWorld = new THREE.Vector3();
var scratchProjector = new THREE.Projector();
THREEx.ObjCoord.convertWorldToScreenSpace	= function(worldPosition, camera){
	var projector	= scratchProjector;
	scratchWorld.copy( worldPosition )
	var screenPos	= projector.projectVector( scratchWorld, camera );
	return screenPos;
}
